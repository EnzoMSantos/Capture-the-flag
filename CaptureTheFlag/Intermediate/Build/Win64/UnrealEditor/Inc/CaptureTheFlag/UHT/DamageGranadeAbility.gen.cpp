...
struct Z_CompiledInDeferFile_FID_Git_Capture_the_flag_CaptureTheFlag_Source_CaptureTheFlag_Public_DamageGranadeAbility_h__Script_CaptureTheFlag_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UDamageGranadeAbility, UDamageGranadeAbility::StaticClass, TEXT("UDamageGranadeAbility"), &Z_Registration_Info_UClass_UDamageGranadeAbility, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDamageGranadeAbility), 2347722412U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Git_Capture_the_flag_CaptureTheFlag_Source_CaptureTheFlag_Public_DamageGranadeAbility_h__Script_CaptureTheFlag_3694155392(TEXT("/Script/CaptureTheFlag"),
