...
struct Z_CompiledInDeferFile_FID_Git_Capture_the_flag_CaptureTheFlag_Source_CaptureTheFlag_Public_DamageGranadeAbility_h__Script_CaptureTheFlag_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UDamageGranadeAbility, UDamageGranadeAbility::StaticClass, TEXT("UDamageGranadeAbility"), &Z_Registration_Info_UClass_UDamageGranadeAbility, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDamageGranadeAbility), 1703464496U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Git_Capture_the_flag_CaptureTheFlag_Source_CaptureTheFlag_Public_DamageGranadeAbility_h__Script_CaptureTheFlag_2922820596(TEXT("/Script/CaptureTheFlag"),
